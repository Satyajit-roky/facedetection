...
classifier = cv2.CascadeClassifier(r"C:/Users/satya/OneDrive/Desktop/face detection project/face detection project/haarcascade_frontalface_default.xml")
